...
export default function ListGirl() {
	return (<div style={{marginBlock:"40px"}}>
			{demoList.map((list,index) => <Item isReverse={index % 2 === 0} key={index}/>)}
...
const Item = ({isReverse}:any) => {
	return <div className={`box girl-item ${isReverse && 'flex-reverse'}`}>
		...
		<div className={'girl-item-info'} style={{textAlign:isReverse ? "right" : "left"}}>
			<h1>Ho Huu Phuoc</h1>
